    ...
    <div class="right_table" style="width:96%;">
        <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#c6c6c6">
            ...
            <tr>
                ...
                <td bgcolor="#FFFFFF" style="text-align:left; ">
                    <input type="text" name="csx" id="csx" style="height:25px;width: 99%; border:1px solid #CCC;"/>
                    <!-- 改-->
                </td>
            </tr>
...
<script type="text/javascript">
    ...
    $(function () {
        // 获取当前id的标准信息
        $.get("${basePath}/ftu_bz_gjts/selectByPrimaryKey/" + id, function (data) {		// 改
    ...
    function commit() {
        ...
        if (csx === "" || csx == null || csx.replace(/(^\s*)|(\s*$)/g, "") === "") {
            ...
            $.ajax({
                ...
                url: '${basePath}/ftu_bz_gjts/updateByPrimaryKey',		// 改
