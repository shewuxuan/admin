...
<script type="text/javascript">
    $(function () {
        $('#dg').datagrid({
            ...
            url: '${basePath}/ftu_bz_cyjdcs/selectByPage',             // 改
            method: 'get',
            iconCls: 'icon-ok',
            nowrap: true,
            ...
            columns: [[
                ...
                {field: 'clx', halign: 'center', align: "center", title: '测量项', width: '77%'},     // 改
                {
                    field: 'trans',
                    halign: 'center',
                    align: "left",
...
<script type="text/javascript">
    ...
    function addRecord() {
        ...
        window.open("${basePath}/bz/ftu/cyjdcs/addCyjdcs", "_blank", " height=500,width=1000,top=" + t + ",left=" + w + ",toolbar=no,menubar=no,localtion=no,scrollbars=no");     // 改
    }
    ...
    function updRecord(id) {
        var w = window.screen.width / 2 - 950 / 2;
        var t = window.screen.height / 2 - 600 / 2 - 35;
        window.open("${basePath}/bz/ftu/cyjdcs/updCyjdcs/" + id, "_blank", " height=500,width=1000,top=" + t + ",left=" + w + ",toolbar=no,menubar=no,localtion=no,scrollbars=no");     // 改
    }
    ...
    function delRecord(id) {
        ...
        $.ajax({
            url: '${basePath}/ftu_bz_cyjdcs/deleteByPrimaryKey/' + id,      // 改
            type: 'POST',
            async: false,
    ...
    function selRecord() {
        ...
        $('#dg').datagrid('options').url = '${basePath}/ftu_bz_cyjdcs/selectByPage';       // 改
