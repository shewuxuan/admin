...
<script type="text/javascript">
    ...
    $(function () {
        // 获取当前id的标准信息
        $.get("${basePath}/ftu_bz_cyjdcs/selectByPrimaryKey/" + id, function (data) {		// 改
...
<script type="text/javascript">
    ...
    function commit() {
        let clx = $("#clx").val();
        if (clx === "" || clx == null || clx.replace(/(^\s*)|(\s*$)/g, "") === "") {
            alert("测量项不能为空！");
            $("#clx").focus();
            return false;
        } else {
            ...
            $.ajax({
                ...
                url: '${basePath}/ftu_bz_cyjdcs/updateByPrimaryKey',		// 改
