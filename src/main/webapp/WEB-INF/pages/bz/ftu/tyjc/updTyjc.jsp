...
<div class="right_main">
    <div class="right_table" style="width:96%;">
        <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#c6c6c6">
            ...
            <tr>
                <th bgcolor="#FFFFFF"><p>检查项目</p></th>        <!-- 改-->
                <td bgcolor="#FFFFFF" style="text-align:left; ">
                    <input type="text" name="jcxm" id="jcxm" style="height:25px;width: 99%; border:1px solid #CCC;"/>
                    <!-- 改-->
                </td>
            </tr>
...
<script type="text/javascript">
    ...
    $(function () {
        // 获取当前id的标准信息
        $.get("${basePath}/ftu_bz_tyjc/selectByPrimaryKey/" + id, function (data) {		// 改
...
<script type="text/javascript">
    ...
    function commit() {
        let jcxm = $("#jcxm").val();
        if (jcxm === "" || jcxm == null || jcxm.replace(/(^\s*)|(\s*$)/g, "") === "") {
            alert("检查项目不能为空！");
            $("#jcxm").focus();
            return false;
        } else {
            ...
            $.ajax({
                ...
                url: '${basePath}/ftu_bz_tyjc/updateByPrimaryKey',		// 改
