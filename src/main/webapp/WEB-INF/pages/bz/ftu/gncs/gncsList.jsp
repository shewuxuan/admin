...
测试功能：<input type="text" name="csgn" id="csgn" style="height:25px;width: 200px; border:1px solid #CCC;"/>        <!-- 改 -->
技术标准或测试要求：<input type="text" name="jsbz" id="jsbz" style="height:25px;width: 200px; border:1px solid #CCC;"/>        <!-- 改 -->
...
<table id="dg" class="easyui-datagrid" title="功能测试标准" style="width:100%;height:auto"
...
<script type="text/javascript">
    ...
    $(function () {
        $('#dg').datagrid({
            ...
            url: '${basePath}/ftu_bz_gncs/selectByPage',             // 改
            method: 'get',
            iconCls: 'icon-ok',
            nowrap: true,
            ...
            columns: [[
                ...
                {field: 'csgn', halign: 'center', align: "center", title: '测试功能', width: '27%'},     // 改
                {field: 'jsbz', halign: 'center', align: "center", title: '技术标准或测试要求', width: '50%'},     // 改
                {
                    field: 'trans',
                    halign: 'center',
                    align: "left",
...
<script type="text/javascript">
    ...
    function addRecord() {
        ...
        window.open("${basePath}/bz/ftu/gncs/addGncs", "_blank", " height=500,width=1000,top=" + t + ",left=" + w + ",toolbar=no,menubar=no,localtion=no,scrollbars=no");     // 改
    }
    ...
    function updRecord(id) {
        var w = window.screen.width / 2 - 950 / 2;
        var t = window.screen.height / 2 - 600 / 2 - 35;
        window.open("${basePath}/bz/ftu/gncs/updGncs/" + id, "_blank", " height=500,width=1000,top=" + t + ",left=" + w + ",toolbar=no,menubar=no,localtion=no,scrollbars=no");     // 改
    }
    ...
    function delRecord(id) {
        ...
        $.ajax({
            url: '${basePath}/ftu_bz_gncs/deleteByPrimaryKey/' + id,      // 改
            type: 'POST',
            async: false,
    ...
    function selRecord() {
        ...
        $('#dg').datagrid('options').url = '${basePath}/ftu_bz_gncs/selectByPage';       // 改
