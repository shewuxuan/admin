...
<script type="text/javascript">
    $(function () {
        ...
        $.get("${basePath}/pwbh_bz_lpjy/selectByPrimaryKey/" + id, function (data) {		// 改
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        if (csjg === "" || csjg == null || csjg.replace(/(^\s*)|(\s*$)/g, "") === "") {
            ...
            let data = {"id": "${requestScope.id}", "ssqy": ssqy, "csjg": csjg}
            $.ajax({
                type: 'POST',
                ...
                dataType: "json",//必须
                url: '${basePath}/pwbh_bz_lpjy/updateByPrimaryKey',		// 改
