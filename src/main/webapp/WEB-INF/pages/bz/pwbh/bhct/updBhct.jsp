        ...
        <form name="myForm" id="myForm">
            <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#c6c6c6">
                ...
                <tr>
                    ...
                    <td bgcolor="#FFFFFF" style="text-align:left; ">
                        <input type="text" name="xb" id="xb" style="height:25px; width: 99%; border:1px solid #CCC;"/>
                        <!-- 改-->
                    </td>
                </tr>
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        if (xb === "" || xb == null || xb.replace(/(^\s*)|(\s*$)/g, "") === "") {
            ...
            let data = {"id": "${requestScope.id}", "ssqy": ssqy, "xb": xb}
            $.ajax({
                type: 'POST',
                ...
                dataType: "json",//必须
                url: '${basePath}/pwbh_bz_bhct/updateByPrimaryKey',		// 改
