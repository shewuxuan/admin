...
<script type="text/javascript">
    $(function () {
        ...
        $.get("${basePath}/pwbh_bz_zzsy/selectByPrimaryKey/" + id, function (data) {		// 改
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        if (jyxm === "" || jyxm == null || jyxm.replace(/(^\s*)|(\s*$)/g, "") === "") {
            ...
            let data = {"id": "${requestScope.id}", "ssqy": ssqy, "jyxm": jyxm}
            $.ajax({
                type: 'POST',
                ...
                dataType: "json",//必须
                url: '${basePath}/pwbh_bz_zzsy/updateByPrimaryKey',		// 改
