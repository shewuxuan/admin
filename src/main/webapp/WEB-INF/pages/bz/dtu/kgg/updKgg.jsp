...
<script type="text/javascript">
    $(function () {
        ...
        $.get("${basePath}/bzkgg/selectByPrimaryKey/" + id, function (data) {		// 改
    ...
    function commit() {
        ...
        if (jg === "" || jg == null || jg.replace(/(^\s*)|(\s*$)/g, "") === "") {
            ...
            $.ajax({
                ...
                data: data,
                url: '${basePath}/bzkgg/updateByPrimaryKey/' + "${requestScope.id}",		// 改
