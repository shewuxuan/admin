    ...
    <div class="right_table" style="width:96%;">
        <form name="myForm" id="myForm">
            <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#c6c6c6">
                ...
                <tr>
                    <th bgcolor="#FFFFFF"><p>测量项</p></th>        <!-- 改-->
                    <td bgcolor="#FFFFFF" style="text-align:left; ">
                        <input type="text" name="clx" id="clx" style="height:25px;width: 99%; border:1px solid #CCC;"/>
                        <!-- 改-->
                    </td>
                </tr>
...
<script type="text/javascript">
    $(function () {
        ...
        $.get("${basePath}/bzcyjd/selectByPrimaryKey/" + id, function (data) {		// 改
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        if (jg === "" || jg == null || jg.replace(/(^\s*)|(\s*$)/g, "") === "") {
            ...
            $("#azyq").focus();
            return false;
        } else if (csgn === "" || csgn == null || csgn.replace(/(^\s*)|(\s*$)/g, "") === "") {
            alert("测试功能不能为空！");
            $("#csgn").focus();
            return false;
        } else if (clx === "" || clx == null || clx.replace(/(^\s*)|(\s*$)/g, "") === "") {
            alert("测量项不能为空！");
            $("#clx").focus();
            return false;
            ...
            $.ajax({
                ...
                data: data,
                url: '${basePath}/bzcyjd/updateByPrimaryKey/' + "${requestScope.id}",		// 改
