...
<!-- 改 -->
测量项：<input type="text" name="clx" id="clx" style="height:25px;width: 400px; border:1px solid #CCC;"/>        <!-- 改 -->
...
<table id="dg" class="easyui-datagrid" title="采样精度" style="width:100%;height:auto"
...
<script type="text/javascript">
    ...
    $(function () {
        $('#dg').datagrid({
            ...
            url: '${basePath}/bzcyjd/selectByPage',             // 改
            method: 'get',
            iconCls: 'icon-ok',
            nowrap: false,
...
<script type="text/javascript">
    ...
    function addRecord() {
        ...
        window.open("${basePath}/bz/dtu/cyjd/addCyjd", "_blank", " height=500,width=1000,top=" + t + ",left=" + w + ",toolbar=no,menubar=no,localtion=no,scrollbars=no");     // 改
    }
    ...
    function updRecord(id) {
        var w = window.screen.width / 2 - 950 / 2;
        var t = window.screen.height / 2 - 600 / 2 - 35;
        window.open("${basePath}/bz/dtu/cyjd/updCyjd/" + id, "_blank", " height=500,width=1000,top=" + t + ",left=" + w + ",toolbar=no,menubar=no,localtion=no,scrollbars=no");     // 改
    }
    ...
    function delRecord(id) {
        ...
        $.ajax({
            url: '${basePath}/bzcyjd/deleteByPrimaryKey/' + id,      // 改
            type: 'POST',
            async: false,
    ...
    function selRecord() {
        ...
        queryParams.clx = $("#clx").val();        // 改

        $('#dg').datagrid('options').url = '${basePath}/bzcyjd/selectByPage';       // 改
