        ...
        <form name="myForm" id="myForm" action="${basePath}/ssqy/selectSsqyByAll" method="post">
            <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#c6c6c6">
                ...
                <tr>
                    ...
                    <td bgcolor="#FFFFFF" style="text-align:left; ">
                        <input type="text" name="bchl" id="bchl" style="height:25px; border:1px solid #CCC;"/></td>
                </tr>

                <tr>
                    <th bgcolor="#FFFFFF"><p>试验电压</p></th>
                    <td bgcolor="#FFFFFF" style="text-align:left; ">
...
<script type="text/javascript">
    $(function () {
        ...
        $.get("${basePath}/bzjydz/selectByPrimaryKey/" + id, function (data) {		// 改url
    ...
    function commit() {
        ...
        if (bchl === "" || bchl == null || bchl.replace(/(^\s*)|(\s*$)/g, "") === "") {
            ...
            $.ajax({
                ...
                data: data,
                url: '${basePath}/bzjydz/updateByPrimaryKey/' + "${requestScope.id}",
