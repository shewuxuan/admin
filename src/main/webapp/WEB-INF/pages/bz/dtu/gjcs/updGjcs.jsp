    ...
    <div class="right_table" style="width:96%;">
        <form name="myForm" id="myForm">
            <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#c6c6c6">
                ...
                <tr>
                    <th bgcolor="#FFFFFF"><p>告警类型</p></th>        <!-- 改-->
                    <td bgcolor="#FFFFFF" style="text-align:left; ">
                        <input type="text" name="gjlx" id="gjlx"
...
<script type="text/javascript">
    $(function () {
        ...
        $.get("${basePath}/bzgjcs/selectByPrimaryKey/" + id, function (data) {		// 改
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        if (jg === "" || jg == null || jg.replace(/(^\s*)|(\s*$)/g, "") === "") {
            ...
            $("#jg").focus();
            return false;
        } else if (gjlx === "" || gjlx == null || gjlx.replace(/(^\s*)|(\s*$)/g, "") === "") {
            alert("告警类型不能为空！");
            $("#gjlx").focus();
            return false;
            ...
            $.ajax({
                ...
                data: data,
                url: '${basePath}/bzgjcs/updateByPrimaryKey/' + "${requestScope.id}",		// 改
