...
安装要求：<input type="text" name="azyq" id="azyq" style="height:25px;width: 800px; border:1px solid #CCC;"/>
<!-- 改 -->
...
<table id="dg" class="easyui-datagrid" title="CT安装工艺检查标准" style="width:100%;height:auto"
...
<script type="text/javascript">
    ...
    $(function () {
        $('#dg').datagrid({
            ...
            url: '${basePath}/bzctgy/selectByPage',             // 改
            method: 'get',
            iconCls: 'icon-ok',
            nowrap: false,
            ...
            columns: [[
                ...
                {field: 'azyq', halign: 'center', align: "center", title: '安装要求', width: '75%'},        // 改
                {
                    field: 'trans',
                    halign: 'center',
                    align: "left",
...
<script type="text/javascript">
    ...
    function addRecord() {
        ...
        window.open("${basePath}/bz/dtu/ctgy/addCtgy", "_blank", " height=500,width=1000,top=" + t + ",left=" + w + ",toolbar=no,menubar=no,localtion=no,scrollbars=no");     // 改
    }
    ...
    function updRecord(id) {
        var w = window.screen.width / 2 - 950 / 2;
        var t = window.screen.height / 2 - 600 / 2 - 35;
        window.open("${basePath}/bz/dtu/ctgy/updCtgy/" + id, "_blank", " height=500,width=1000,top=" + t + ",left=" + w + ",toolbar=no,menubar=no,localtion=no,scrollbars=no");     // 改
    }
    ...
    function delRecord(id) {
        ...
        $.ajax({
            url: '${basePath}/bzctgy/deleteByPrimaryKey/' + id,      // 改
            type: 'POST',
            async: false,
    ...
    function selRecord() {
        ...
        queryParams.azyq = $("#azyq").val();        // 改

        $('#dg').datagrid('options').url = '${basePath}/bzctgy/selectByPage';       // 改
