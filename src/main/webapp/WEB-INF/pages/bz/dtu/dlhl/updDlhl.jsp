...
<head>
    ...
    <title>修改标准——模拟CT一次电流验证回路</title>                    <!-- 改-->
    ...
    <div class="right_table" style="width:96%;">
        <form name="myForm" id="myForm">
            <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#c6c6c6">
                ...
                <tr>
                    <th bgcolor="#FFFFFF"><p>测量方法</p></th>        <!-- 改-->
                    <td bgcolor="#FFFFFF" style="text-align:left; ">
                        <input type="text" name="csff" id="csff"
...
<script type="text/javascript">
    $(function () {
        ...
        $.get("${basePath}/bzdlhl/selectByPrimaryKey/" + id, function (data) {		// 改
...
<script type="text/javascript">
    ...
    function commit() {
        ...
        if (jg === "" || jg == null || jg.replace(/(^\s*)|(\s*$)/g, "") === "") {
            ...
            $("#csgn").focus();
            return false;
        } else if (csff === "" || csff == null || csff.replace(/(^\s*)|(\s*$)/g, "") === "") {
            alert("测试方法不能为空！");
            $("#csff").focus();
            return false;
            ...
            $.ajax({
                ...
                data: data,
                url: '${basePath}/bzdlhl/updateByPrimaryKey/' + "${requestScope.id}",		// 改
