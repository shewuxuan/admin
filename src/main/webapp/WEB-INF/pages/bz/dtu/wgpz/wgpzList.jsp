...
<script type="text/javascript">
    $(function () {
        $('#dg').datagrid({
            ...
            url: '${basePath}/bzwgpz/selectByPage',
            method: 'get',
            iconCls: 'icon-ok',
            nowrap: false,
            ...
            columns: [[
                ...
                {field: 'csxm', halign: 'center', align: "center", title: '测试项目', width: '25%'},
                {field: 'csyq', halign: 'center', align: "center", title: '技术标准及测试要求', width: '50%'},
                {
                    field: 'trans',
                    halign: 'center',
                    align: "left",
...
<script type="text/javascript">
    ...
    function delRecord(id) {
        ...
        $.ajax({
            url: '${basePath}/bzwgpz/deleteByPrimaryKey/' + id,
            type: 'POST',
            async: false,
    ...
    function selRecord() {
        ...
        queryParams.csxm = $("#csxm").val();
        queryParams.csyq = $("#csyq").val();
