...
回路：<input type="text" name="hl" id="hl" style="height:25px;width: 100px; border:1px solid #CCC;"/>        <!-- 改 -->
<%--装置类型：<select name="zzlx" id="zzlx" style="height:25px; border:1px solid #CCC;"></select>--%>
...
<table id="dg" class="easyui-datagrid" title="CT回路电阻标准" style="width:100%;height:auto"
...
<script type="text/javascript">
    ...
    $(function () {
        $('#dg').datagrid({
            ...
            url: '${basePath}/bzhldz/selectByPage',             // 改
            method: 'get',
            iconCls: 'icon-ok',
            nowrap: false,
...
<script type="text/javascript">
    ...
    function addRecord() {
        ...
        window.open("${basePath}/bz/dtu/hldz/addHldz", "_blank", " height=500,width=1000,top=" + t + ",left=" + w + ",toolbar=no,menubar=no,localtion=no,scrollbars=no");     // 改
    }
    ...
    function updRecord(id) {
        var w = window.screen.width / 2 - 950 / 2;
        var t = window.screen.height / 2 - 600 / 2 - 35;
        window.open("${basePath}/bz/dtu/hldz/updHldz/" + id, "_blank", " height=500,width=1000,top=" + t + ",left=" + w + ",toolbar=no,menubar=no,localtion=no,scrollbars=no");     // 改
    }
    ...
    function delRecord(id) {
        ...
        $.ajax({
            url: '${basePath}/bzhldz/deleteByPrimaryKey/' + id,      // 改
            type: 'POST',
            async: false,
    ...
    function selRecord() {
        ...
        $('#dg').datagrid('options').url = '${basePath}/bzhldz/selectByPage';       // 改
